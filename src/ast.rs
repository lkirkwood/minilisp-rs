...
fn two_arg_parexpr_to_string(op_char: char, first: Expression, second: Expression) -> String {
    format!(
        "({op_char} {} {})",
        String::from(first),
        String::from(second)
...
impl From<ParenExpression> for String {
    fn from(value: ParenExpression) -> Self {
        match value {
